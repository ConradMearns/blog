...
function setup() {
  ...
  rocket_man.orbital_focus = bowie
  // rocket_man.orbital_focus = sun
  rocket_man.set_deprecated(createVector(0,0), random(0.5, 0.9), random(width/16, width/10), radians(0))
  

  let a = new AstroBody()
  a.orbital_focus = rocket_man
  a.set_deprecated(createVector(0,0), random(0, 0.5), random(width/32, width/16), radians(0))
